  ...
  Widget build(BuildContext context) {
    List<Widget> childrens = [
      ...
      ListTile(
        ...
        onTap: () {
          Navigator.of(context).push(
              MaterialPageRoute(builder: (context) => MyDetails('Details')));
        },
      ),
    ];
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => MyDetails(productLabel)),
        );
      },
    );
  }
...
class MyDetails extends StatelessWidget {
  String? title;
  MyDetails(this.title, {Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    String pageTitle = title ?? "Detail";
    return Scaffold(
      ...
      body: DefaultTabController(
        ...
        child: Scaffold(
          appBar: AppBar(
            ...
            title: Text(pageTitle, style: const TextStyle(color: Colors.grey)),
            actions: const [
              AppBarActionsShare(),
            ],
            // TODO: Add TabBar
          ...
          body: TabBarView(
            children: [
              SizedBox(
                child: Center(
                  child: Text('$pageTitle : Tab Page 1'),
                ),
              ),
              SizedBox(
                child: Center(
                  child: Text('$pageTitle : Tab Page 2'),
                ),
              ),
              SizedBox(
                child: Center(
                  child: Text('$pageTitle : Tab Page 3'),
                ),
              ),
              SizedBox(
                child: Center(
                  child: Text('$pageTitle : Tab Page 4'),
                ),
              ),
            ],
          ),
